...
public class TriangleTest
{
    ...
    public void InitTriangleTest()
    {
        ...
        Assert.Less(Math.Abs(triangle.EdgeA - a), Constants.CALCULATION_ACCURACY);
        Assert.Less(Math.Abs(triangle.EdgeB - b), Constants.CALCULATION_ACCURACY);
        Assert.Less(Math.Abs(triangle.EdgeC - c), Constants.CALCULATION_ACCURACY);
    }
    ...
    public void GetSquareTest()
    {
        ...
        Assert.Less(Math.Abs(square.Value - result), Constants.CALCULATION_ACCURACY);
    }
